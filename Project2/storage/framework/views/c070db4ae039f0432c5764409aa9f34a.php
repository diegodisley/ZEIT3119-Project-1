                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="TotalSpending">View Total Spending</a></li>
                ...
                <div class="col-md-12">
                    <div class="h-100 p-5 bg-body-tertiary border rounded-5">
                        <center>
                            ...
                            <hr><br>
                            <img src="Images\Pie chart.png" class="img-fluid" alt="pie chart" style="width:33%;">
                            <img src="Images\Bar graph.png" class="img-fluid" alt="bar graph" style="width:60%; float: right; border-radius: 5%;">
                            <br><hr>
                        </center>
                    </div>
                </div>
...
</html><?php /**PATH C:\laragon\www\project2\resources\views/TotalSpending.blade.php ENDPATH**/ ?>