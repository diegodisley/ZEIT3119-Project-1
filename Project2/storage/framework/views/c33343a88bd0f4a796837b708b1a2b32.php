...
<html lang="en">
    ...
    <body>
        ...
        <div class="container min-vh-100 d-flex justify-content-center align-items-center">
            ...
            <?php echo Form::open(['url' => route('index'), 'id' => 'signinForm']); ?>

            <center>
                <img class="mb-4" src="Images\logo.png" alt="Logo" width="160" height="140">
                <h1 class="h3 mb-3 fw-normal">Please sign in</h1>
                <div class="form-floating">
                    <?php echo Form::email('email', null, ['class' => 'form-control', 'placeholder' => 'Email', 'id' => 'email', 'required']); ?>

                    <label for="email">Email</label>
                </div>
                <div class="form-floating">
                    <?php echo Form::password('password', ['class' => 'form-control', 'placeholder' => 'Password', 'id' => 'password', 'required']); ?>
                ...
                <!-- Submit button -->
                <?php echo Form::submit('Sign In', ['class' => 'w-100 btn btn-lg btn-primary', 'style' => 'background-color:rgb(65, 125, 238);']); ?>
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Proj/project2/resources/views/index.blade.php ENDPATH**/ ?>