    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="About"><i class="fa-solid fa-users"></i>
                                About Us
                            </a>
                        </li>
        ...
        <div class="container min-vh-100 d-flex justify-content-center align-items-center">
            <div class="h-100 p-5 bg-body-tertiary border rounded-5">
                ...
                <h2>Developers</h2>
                <p> We created this web application because we want to help people record and organise their expenses more efficiently</p>
                <h3> Diego Disley - Chitipat Marsri - Mitchell Torrisi </h3>
                </center>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\laragon\www\project2\resources\views/About.blade.php ENDPATH**/ ?>