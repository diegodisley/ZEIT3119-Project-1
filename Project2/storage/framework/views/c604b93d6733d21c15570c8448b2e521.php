                ...
                <center>
                    ...
                    <hr><table class="table table-hover" style="text-align:center" id="transactionTable">
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo e(url('EditTransaction/' . $transaction->invoice_number)); ?>"><button style="border: none; background-color:transparent;"><i class="fa-solid fa-ellipsis"></i></button></a></td>
                            <td><a href="<?php echo e(url('DeleteTransaction/' . $transaction->invoice_number)); ?>"><button style="border: none; background-color:transparent;"><i class="fa-solid fa-trash-can"></i></button></a></td>
                        </tr>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Proj/project2/resources/views/PreviousTransaction.blade.php ENDPATH**/ ?>