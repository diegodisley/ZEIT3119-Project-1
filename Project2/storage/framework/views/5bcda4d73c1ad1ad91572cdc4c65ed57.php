        ...
        <div class="col-md-12">
            <div class="h-100 p-5 bg-body-tertiary border rounded-5">
                <center>
                    ...
                    <hr>
                    <form>
                        <img src="Images\Person.png" class="img-fluid" alt="profile picture" style="width:40%;">
                        <br><br>
                        <p>First name: <?php echo e($user->first_name); ?></p>
                        <p>Last name: <?php echo e($user->last_name); ?></p>
                        <p>Date of birth: <?php echo e($user->DoB); ?></p>
                        <p>Email: <?php echo e($user->email); ?></p>
                        <a href="EditAccount" class="button" onclick="return confirm('Are you sure you want to edit you user information?')">Edit</a>
                    </form>
                </center>
            </div>
        </div>
...
</html><?php /**PATH C:\laragon\www\project2\resources\views/ViewAccount.blade.php ENDPATH**/ ?>