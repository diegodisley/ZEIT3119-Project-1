...
<html lang="en">
    ...
    <body>
                ...
                <div class="col-md-12">
                    <div class="h-100 p-5 bg-body-tertiary border rounded-5">
                        <center>
                            ...
                            <hr><br>
                            <!-- Changed the form to use Laravel's POST method for submission -->
                            <?php echo Form::open(['url' => '/NewTransaction', 'id' => 'transactionForm']); ?>

                                <div class="form-floating">
                                    <?php echo Form::number('invoiceNumber', null, ['class' => 'form-control', 'placeholder' => 'Invoice Number', 'id' => 'invoice_number', 'required']); ?>

                                    <label for="invoiceNumber">Invoice Number</label>
                                </div>
                                <div class="form-floating">
                                    <?php echo Form::number('price', null, ['class' => 'form-control', 'placeholder' => 'Price', 'id' => 'amount', 'required']); ?>

                                    <label for="price">Price</label>
                                </div>
                                <div class="form-floating">
                                    <?php echo Form::date('date', null, ['class' => 'form-control', 'placeholder' => 'Date', 'id' => 'date', 'required']); ?>

                                    <label for="date">Date</label>
                                </div>
                                <div class="form-floating">
                                    <?php echo Form::select('category', ['Personal' => 'Personal', 'Business' => 'Business', 'Education' => 'Education', 'ETC' => 'ETC'], null, ['class' => 'form-select', 'id' => 'categorySelect', 'aria-label' => 'Floating label select example']); ?>

                                    <label for="categorySelect">Category</label>
                                </div>
                                <!-- Submit button -->
                                <?php echo Form::submit('Add', ['class' => 'button', 'onclick' => 'return confirmTransaction()']); ?>
        ...
        <script>
            ...
            formFile.addEventListener("change", displayImage); 
            ...
            function addTransaction() {
                var transaction = {
                    invoiceId: document.getElementById("invoiceIdInput").value,
            ...
            function confirmTransaction() {
                var invoiceNumber = document.getElementById("invoiceIdInput").value;
                var price = document.getElementById("priceInput").value;
                var date = document.getElementById("dateInput").value;
                var category = document.getElementById("categorySelect").value;
                
                // Check if any of the fields is empty or the category is not chosen
                if (invoiceNumber === "" || price === "" || date === "" || category === "Choose") {
...
<?php /**PATH C:\laragon\www\project2\resources\views/NewTransaction.blade.php ENDPATH**/ ?>