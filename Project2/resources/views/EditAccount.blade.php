...
<html lang="en">
    ...
    <div class="container min-vh-100 d-flex justify-content-center align-items-center">
        ...
        {{ Form::open(['url' => '/EditAccount', 'id' => 'profileForm']) }}
        <center>
            <h2>My Profile</h2>
            <hr><br>
            <div class="form-floating">
                {{ Form::text('firstName', $user->first_name, ['class' => 'form-control', 'placeholder' => 'First Name', 'id' => 'firstName']) }}
                <label for="firstName">First Name</label>
            </div>
            <div class="form-floating">
                {{ Form::text('lastName', $user->last_name, ['class' => 'form-control', 'placeholder' => 'Last Name', 'id' => 'lastName']) }}
                <label for="lastName">Last Name</label>
            </div>
            <div class="form-floating">
                {{ Form::date('dob', $user->DoB, ['class' => 'form-control', 'placeholder' => 'Date Of Birth', 'id' => 'dob']) }}
                <label for="dob">Date of Birth</label>
            </div>
            <div class="form-floating">
                {{ Form::email('email', $user->email, ['class' => 'form-control', 'placeholder' => 'Email', 'id' => 'email']) }}
                <label for="email">Email</label>
            </div>
            {{ Form::submit('Save Changes', ['class' => 'button', 'onclick' => 'return confirm("Are you sure you want to save your changes?")']) }}
        </center>
        {{ Form::close() }}
        </div>
        </div>
