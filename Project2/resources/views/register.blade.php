...
<html lang="en">
    ...
    <body>
        ...
        <div class="container min-vh-100 d-flex justify-content-center align-items-center">
            ...
            {{ Form::open(array('url' => '/register', 'id' => 'registrationForm')) }}
                <center>
                    ...
                    <!-- Changed inputs to use Laravel's Form helper -->
                    <div class="form-floating">
                        {{ Form::text('firstName', null, ['class' => 'form-control', 'placeholder' => 'First Name', 'id' => 'firstName', 'required']) }}
                        <label for="firstName">First Name</label>
                    </div>
                    <div class="form-floating">
                        {{ Form::text('lastName', null, ['class' => 'form-control', 'placeholder' => 'Last Name', 'id' => 'lastName', 'required']) }}
                        <label for="lastName">Last Name</label>
                    </div>
                    <div class="form-floating">
                        {{ Form::date('dob', null, ['class' => 'form-control', 'placeholder' => 'Date Of Birth', 'id' => 'dob', 'required']) }}
