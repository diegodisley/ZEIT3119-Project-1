                ...
                <div class="col-md-12">
                    <div class="h-100 p-5 bg-body-tertiary border rounded-5">
                        <center>
                            ...
                            {!! Form::open(['url' => '/NewTransaction', 'id' => 'transactionForm']) !!}
                                <div class="form-floating">
                                    {!! Form::number('invoiceNumber', null, ['class' => 'form-control', 'placeholder' => 'Invoice Number', 'id' => 'invoice_number', 'required']) !!}
                                    <label for="invoiceNumber">Invoice Number</label>
                                </div>
                                <div class="form-floating">
                                    {!! Form::number('price', null, ['class' => 'form-control', 'placeholder' => 'Price', 'id' => 'amount', 'required']) !!}
                                    <label for="price">Price</label>
                                </div>
                                <div class="form-floating">
                                    {!! Form::date('date', null, ['class' => 'form-control', 'placeholder' => 'Date', 'id' => 'date', 'required']) !!}
                                    <label for="date">Date</label>
                                </div>
                                <div class="form-floating">
                                    {!! Form::select('category', ['Personal' => 'Personal', 'Business' => 'Business', 'Education' => 'Education', 'ETC' => 'ETC'], null, ['class' => 'form-select', 'id' => 'categorySelect', 'aria-label' => 'Floating label select example']) !!}
                                    <label for="categorySelect">Category</label>
                                </div>
                                <!-- Submit button -->
                                {!! Form::submit('Add', ['class' => 'button', 'onclick' => 'return confirmTransaction()']) !!}
                            {!! Form::close() !!}
                        </center>
                    </div>
                </div>
